...
export default function Paymentdetails(){
    ...
    function sendData (e)  {
        ...
        //const isValid = validate();
            ...
            axios.post('/api/payment', {city, postal_code, address, contactNo }, {
                headers: {Authorization: token}
            })
            alert("You have successfully added delivery details.")
            history.push('/addpayment2');
                        ...
                        <div className = "card-body" >    
                                ...
                                <form onSubmit={sendData} style ={{alignContent:"center"}}>
                                    ...
                                    <Form.Group className="mb-3" controlId="formBasicid">
                                        ...
                                        <Form.Control type="number" className="form-control" id="postal_code"  placeholder="" required
                                        onChange = {(e) => {
                                    ...
                                    <Form.Group className="mb-3" controlId="formBasicid">
                                        ...
                                        <Form.Control type="text" className="form-control" id="address" placeholder=""  required
                                        onChange = {(e) => {
                                    ...
                                    <Form.Group className="mb-3" controlId="formBasicid">
                                        ...
                                        <Form.Control type="tel" className="form-control" id="contactNo" pattern ="[0-9]{10}" maxLength = "10" required
                                        onChange = {(e) => {
