    ...
    render(){
        ...
        return (
            <div>
                ...
                <table  id="pdfdiv" style={{marginTop:20, fontSize:"14px",  backgroundColor: "white", float:"center"}}>
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        {filtername.map((p, index)=>{
                            return <tr key={index}>
                                ...
                                <td>
                                    <a style = {{background:"#072344", color:"white"}}className="btn btn-warning" href={`/deliveryupdate/${p._id}`}>
                                        &nbsp;Edit
                                    </a>
                                    &nbsp;
                                    <a style = {{background:"#059DC0"}} className="btn btn-danger" href="#" onClick={() =>this.onDelete(p._id)}>
                                        &nbsp;Delete
                                    </a>
                                    <a style ={{marginLeft:"0.1cm",background:"darkblue"}}className="btn btn-danger" href={`/history/${p.orderID}`}>
                                        &nbsp;View
                                    </a>
                                </td>
